...
describe("Decks", ()=>{
    beforeEach(() => {
      ...
      test("route for /decks/:deckId", async () => {
        ...
        const titleElements = await screen.findAllByText("Mock DeckInList 3");
      ...
      test("route for /decks/new", async () => {
        ...
        const titleElements = await screen.findAllByText("Create DeckInList");
        expect(titleElements.length).toBeGreaterThanOrEqual(1);
      ...
      test("route for /decks/:deckId/edit", async () => {
        ...
        const nameInput = await screen.findByDisplayValue("Mock DeckInList 33");
      ...
      test("route for /decks/:deckId/study", async () => {
        ...
        const deckName = await screen.findByText("Mock Study DeckInList 42");
      ...
      test("route for /decks/:deckId/study clicking flip shows next button", async () => {
        ...
        await screen.findByText("Mock Study DeckInList 73");
      ...
      test("route for /decks/:deckId/study not enough cards", async () => {
        ...
        const deckName = await screen.findByText("Mock Study DeckInList 13");
        expect(deckName).toBeTruthy();
